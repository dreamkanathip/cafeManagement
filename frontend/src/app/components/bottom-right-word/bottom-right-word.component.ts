...
@Component({
  selector: 'app-bottom-right-word',
  templateUrl: './bottom-right-word.component.html',
  styleUrl: './bottom-right-word.component.css'
})
export class BottomRightWordComponent implements OnInit {
